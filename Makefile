...
bochs: iodev/libiodev.a $(DEBUGGER_LIB) \
...
.win32_dll_plugin_target: iodev/libiodev.a $(DEBUGGER_LIB) \
           cpu/libcpu.a memory/libmemory.a gui/libgui.a \
           $(DISASM_LIB)  $(BX_OBJS) \
           $(SIMX86_OBJS) $(FPU_LIB)  
...
libbochs_cpu.a: $(DEBUGGER_LIB) $(BX_OBJS)
	-rm -f libbochs_cpu.a
...
install_win32: download_dlx 
	...
	#cat $(srcdir)/build/win32/DOC-win32.htm | $(SED) -e 's/2.2.6/$(VERSION)/g' > $(prefix)/DOC-win32.htm
